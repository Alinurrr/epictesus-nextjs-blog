...
import PostMetaTitle from './component/PostMetaTitle';
  ...
  return (
    <Layout>
      ...
      <Container>
        ...
        <div className="md:w-10/12 w-full sm:h-96 h-60 relative mx-auto my-10">
          <Image
            src="/detail-image.png" alt="featured thumbnail" className='rounded-xl '
            layout="fill"
            objectFit="cover"
          />
        </div>
